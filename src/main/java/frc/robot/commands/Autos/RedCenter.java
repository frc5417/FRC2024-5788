...
public class RedCenter extends SequentialCommandGroup {
  /** Creates a new Test. */
  public RedCenter(DriveBase driveBase) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());

    Pose2d startPose = new Pose2d(0, 0, Rotation2d.fromDegrees(180));
    Pose2d startPoseY = new Pose2d(-1.2, 0, Rotation2d.fromDegrees(180));
    Pose2d startPose2 = new Pose2d(0.1, 0, Rotation2d.fromDegrees(180));
