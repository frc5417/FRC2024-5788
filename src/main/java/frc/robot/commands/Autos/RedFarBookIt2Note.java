...
public class RedFarBookIt2Note extends SequentialCommandGroup {
  /** Creates a new Test. */
  public RedFarBookIt2Note(DriveBase driveBase) {
    ...
    Pose2d pose4 = new Pose2d(8.3, 0.75, Rotation2d.fromDegrees(-180));
