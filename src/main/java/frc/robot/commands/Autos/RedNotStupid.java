...
public class RedNotStupid extends SequentialCommandGroup {
  /** Creates a new TwoNoteCenter. */
  public RedNotStupid(TargetStateRun targetStateRun, PhotonSubsystem photon) {
    Pose2d startPose = new Pose2d(0, 0, Rotation2d.fromDegrees(45));
    targetStateRun.m_drivebase.resetOdometry(startPose);
    

    Pose2d[] path_back = {startPose, new Pose2d(-2.0, 0, new Rotation2d()), new Pose2d(-2.0, 8, new Rotation2d())}; //x=11 is back
    Pose2d[] path_for = {new Pose2d(-2.0, 8, new Rotation2d()), new Pose2d(-2.0, 0, new Rotation2d()), startPose};
