...
public class BlueFarSide extends SequentialCommandGroup {
  /** Creates a new TwoNoteCenter. */
  public BlueFarSide(TargetStateRun targetStateRun, PhotonSubsystem photon) {
    Pose2d startPose = new Pose2d(1.0, 4.5, Rotation2d.fromDegrees(45));
    Pose2d startPoseCustom = RobotContainer.WPI_to_Custom(startPose);
    targetStateRun.m_drivebase.resetOdometry(RobotContainer.WPI_to_Custom(startPose).times(-1));
