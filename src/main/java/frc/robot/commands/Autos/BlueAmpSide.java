...
public class BlueAmpSide extends SequentialCommandGroup {
  /** Creates a new Test. */
  public BlueAmpSide(DriveBase driveBase) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());

    Pose2d startPose = new Pose2d(0.75, 6.5, Rotation2d.fromDegrees(60));
    Pose2d startPose1 = new Pose2d(0.75, 7, Rotation2d.fromDegrees(0));
    Pose2d startPose2 = new Pose2d(3, 7, Rotation2d.fromDegrees(0));
